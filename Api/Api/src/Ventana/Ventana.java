...
public class Ventana extends JFrame {
    ...
    public void iniciarComponentes() {
        ...
        panel.setBackground(Color.decode("#34a0a4"));
        ...
        etiqueta.setForeground(Color.decode("#ffe5d9"));
        etiqueta.setOpaque(true);
        etiqueta.setBackground(Color.decode("#43aa8b"));
        panel.add(etiqueta);
        ...
        name.setOpaque(true);
        name.setBackground(Color.decode("#9ef01a"));
        panel.add(name);
        ...
        phone.setBackground(Color.decode("#9ef01a"));
        panel.add(phone);
        ...
        cod.setOpaque(true);
        cod.setBackground(Color.decode("#9ef01a"));
        panel.add(cod);
        ...
        carrera.setBackground(Color.decode("#9ef01a"));
        panel.add(carrera);
    }
}
